...
// ✅ Use a safe accessor for Vite env (prevents TS errors if keys aren't typed)
...
export const publicEnv = Object.freeze({
    ...
    /**
     * ✅ FIX: Your .env uses VITE_PUBLIC_APPWRITE_DATABASE_ID (not VITE_PUBLIC_APPWRITE_DATABASE)
